...
INDEX_FILE="${CURRENT_FOLDER}/site_index.md"
INDEX_LINK="..\/site_index.md"
        ...
        do :
            ...
            if [ "$i" -eq 1 ]; then
	            ...
	            if [ -f "${CURRENT_FOLDER}/${filename}/${filename}.md" ]; then
                	...
                	cp "${SETUP_FOLDER}/templates/${PAGES_FOLDER}/${LOCALE_FOLDER}/template.md" "${CURRENT_FOLDER}/${filename}/${filename}.md";
                fi
